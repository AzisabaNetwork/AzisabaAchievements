...
public final class AchievementListScreenSetItemEvent extends AbstractEvent {
    private static final HandlerList HANDLER_LIST = new HandlerList();
    private final Player player;
    private final TranslatedAchievement achievement;
    private final ItemStack itemStack;

    public AchievementListScreenSetItemEvent(@NotNull Player player, @NotNull TranslatedAchievement achievement, @NotNull ItemStack itemStack) {
